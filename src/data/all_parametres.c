...
void create_all_parametres(All_parametres* all_parametres)
{
	...
	all_parametres->model = get_method_value_by_string(get_method(data));
	...
	all_parametres->stb_manufacturing_date = get_method_value_by_string(get_method(data));
    ...
    all_parametres->CA_Provider_Name = get_method_value_by_string(get_method(data));
    
    //loader data
    set_method(data,BOOT_LOADER_CRC);
    all_parametres->boot_loader_crc = get_method_value_by_string(get_method(data));
    ...
    all_parametres->addressing_memory = get_method_value_by_string(get_method(data));
    set_method(data,MEMORY_BLOCK_STATUS);
    all_parametres->memory_block_status = get_method_value_by_string(get_method(data));
    set_method(data,USED_MEMORY);
    all_parametres->used_memory = get_method_value_by_string(get_method(data));
    set_method(data,TOTAL_MEMORY);
    all_parametres->total_memory = get_method_value_by_string(get_method(data));
    ...
    all_parametres->dns_serverII = get_method_value_by_string(get_method(data));
    set_method(data,STB_ETHERNET_PORT_STATUS);//TBD without gather
    all_parametres->stb_ethernet_port_status = get_method_value_by_string(get_method(data));
    set_method(data,ETHERNET_MAC_ADDRESS);
    ...
    all_parametres->IR_Input_Status = get_method_value_by_string(get_method(data));
    ...
    all_parametres->CPU_Utilisation = get_method_value_by_string(get_method(data));
    set_method(data,HDMI_PORT_STATUS);
    all_parametres->HDMI_Port_Status = get_method_value_by_string(get_method(data));
    set_method(data,VIDEO_RESOLUTION);
    all_parametres->Video_Resolution = get_method_value_by_string(get_method(data));
    set_method(data,VIDEO_ASPECT_RATIO);
    all_parametres->Video_Aspect_Ratio = get_method_value_by_string(get_method(data));
    set_method(data,VIDEO_FORMAT);
    all_parametres->Video_Format = get_method_value_by_string(get_method(data));
    set_method(data,DIAGNOSTICS_PAGES_LANGUAGE);
    all_parametres->Diagnostics_Pages_Language = get_method_value_by_string(get_method(data));
    set_method(data,AUDIO_SETUP);
    all_parametres->Audio_Setup = get_method_value_by_string(get_method(data));
